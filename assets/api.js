...
const LapokAPI = (() => {
  ...
  const navManager = [
    { section: 'Daily' },
    { id: 'manager-dashboard', l: 'Dashboard', i: 'home', s: 1 },
    { id: 'manager-stock', l: 'Stock taking', i: 'box', s: 2 },
    { id: 'manager-dispatch', l: 'Dispatch', i: 'fleet', s: 3 },
    { id: 'manager-ccba-boards', l: 'CCBA boards', i: 'chart', s: 4 },
    { id: 'manager-rdc-review', l: 'RDC daily sheets', i: 'chart', s: 5 },
    { id: 'report-exchange', l: 'PDF reports', i: 'receipt', s: 6 },
    { section: 'Approvals' },
...
<p style="margin:16px;font-size:9pt;color:#94A3B8;font-family:Calibri,Arial,sans-serif">Generated by Outpost DMS · ${esc(when)}</p>
    ...
    roleNav: {
      admin: [
        { section: 'Daily' },
        { id: 'admin-console', l: 'System console', i: 'home', s: 1 },
        { id: 'admin-exceptions', l: 'Exception center', i: 'chart', s: 2 },
        { id: 'admin-editreqs', l: 'Edit requests', i: 'edit', s: 3 },
        { id: 'admin-audit', l: 'Audit log', i: 'edit', s: 4 },
        { id: 'report-exchange', l: 'PDF reports', i: 'receipt', s: 5 },
        { id: 'accountant-welfare', l: 'Staff welfare', i: 'edit', s: 6 },
      ...
      accountant: [
        { section: 'Daily' },
        { id: 'accountant-rdc-hub', l: 'Home', i: 'home', s: 1 },
        { id: 'accountant-rdc', l: "Today's close", i: 'chart', s: 2 },
        { id: 'accountant-cash', l: 'Cash handover', i: 'receipt', s: 3 },
        { id: 'report-exchange', l: 'Manager pack', i: 'receipt', s: 4 },
        { id: 'admin-exceptions', l: 'Depot alerts', i: 'chart', s: 5 },
        { section: 'More' },
      ...
      executive: [
        { section: 'Daily' },
        { id: 'admin-dashboard', l: 'Executive dashboard', i: 'home', s: 1 },
        { id: 'director-brief', l: 'Director brief', i: 'chart', s: 2 },
        { id: 'report-exchange', l: 'PDF reports', i: 'receipt', s: 3 },
        { id: 'admin-exceptions', l: 'Exception center', i: 'chart', s: 4 },
        { id: 'accountant-welfare', l: 'Staff welfare', i: 'edit', s: 5 },
        { section: 'More' },
        { id: 'admin-reports', l: 'Reports & analytics', i: 'chart' },
      ...
      cadet: [
        { section: 'Daily' },
        { id: 'cadet-dashboard', l: 'Dashboard', i: 'home', s: 1 },
        { id: 'cadet-daily', l: "Today's report", i: 'eod', s: 2 },
      ],
    },
    rolePill: {
      admin: 'rp-admin',
