-- LAPOK DMS â€” CCBA / MyCCBA integration tables (blueprint v1)
-- Run after schema.sql or on existing lapok_dms:
--   mysql -u root lapok_dms < database/migrations/002_ccba_integration.sql


-- â”€â”€ Product mapping: Lapok SKU â†” MyCCBA catalog code â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
CREATE TABLE IF NOT EXISTS ccba_product_map (
    id              INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    product_id      INT UNSIGNED NOT NULL,
    ccba_sku_code   VARCHAR(80) NOT NULL COMMENT 'e.g. Coke 500ML 01X12 (PET) â€” confirm with CCBA',
...
-- â”€â”€ Outbound replenishment orders (manager creates in Lapok) â”€â”€â”€â”€â”€â”€â”€â”€â”€
CREATE TABLE IF NOT EXISTS ccba_orders (
    ...
    ccba_customer_code      VARCHAR(40) DEFAULT NULL COMMENT 'Outlet/depot code on CCBA â€” TBD',
...
-- â”€â”€ Status timeline (append-only) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ Flexible references (PO, waybill, invoice, etc.) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ Daily stock snapshots for CCBA level-2 sync â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ Link inbound delivery to outbound CCBA order â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ Optional: depot-level CCBA config (no secrets in repo) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
INSERT INTO ccba_config (config_key, config_value, notes) VALUES
    ('portal_url_uganda', 'https://uganda.myccba.africa/', 'MyCCBA Uganda â€” confirm with rep'),
